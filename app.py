...
def carregar_ativos():
    ...
    try:
        ...
        df_historico = pd.read_csv('dados_v5.1_padronizado.csv', parse_dates=['Date'])
    ...
    if time_A == time_B:
        ...
        with st.spinner('Calculando estatísticas e fazendo a previsão...'):
            ...
            def preparar_input(home, away, forma_H, gf_H, gs_H, forma_A, gf_A, gs_A):
                data = {
                    'Home_Forma_10_Jogos': forma_H, 'Home_Media_Gols_Feitos_10J': gf_H, 'Home_Media_Gols_Sofridos_10J': gs_H,
                    'Away_Forma_10_Jogos': forma_A, 'Away_Media_Gols_Feitos_10J': gf_A, 'Away_Media_Gols_Sofridos_10J': gs_A
                }
